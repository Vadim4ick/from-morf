...
export const CreateBasketDocument = gql`
  ...
  create_basket_item(data: {user: {id: $user_id}, good: $goods_id, size: $size}) {
    id
    user {
      id
      email
