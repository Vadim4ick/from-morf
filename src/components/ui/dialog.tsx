...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-[#5B5B5B]/55 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className,
    )}
    {...props}
  />
    ...
    <>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "fixed right-0 top-[calc(var(--header-height)_+_5px)] z-50 h-fit w-full -translate-x-1/2 gap-4 bg-white px-[42px] pb-[42px] pt-[25px]",
          className,
        )}
        {...props}
      >
