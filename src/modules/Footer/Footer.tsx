          ...
          <div className="flex gap-[109px]">
            {footerLinks.map((el) => (
              <div key={el.id} className="flex flex-col">
                <p className="text-blackColor relative mb-5 pb-5 text-center text-[20px] after:absolute after:bottom-0 after:left-1/2 after:h-[1px] after:w-[25px] after:-translate-x-1/2 after:bg-black after:content-['']">
                  {el.title}
                </p>
